...
const FinishRide = (props) => {
  return (
    <div >
      ...
      <div className='flex items-center justify-between mt-4 p-4 border-2 border-yellow-400 rounded-lg mt-4'>
      ...
      <div className='flex  flex-col justify-center items-center'>
        ...
        <div className='w-full'>
            ...
            <Link to='/captain-home' className='w-full mt-5 flex justify-center bg-green-600  text-lg text-white font-semibold p-3 rounded-lg'>
              Finish Ride
            </Link>
